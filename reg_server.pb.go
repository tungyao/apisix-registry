...
type Router struct {
	...
	MRemoteAddrs    []string `protobuf:"bytes,5,rep,name=MRemoteAddrs,proto3" json:"MRemoteAddrs,omitempty"`
	Methods         string   `protobuf:"bytes,6,opt,name=Methods,proto3" json:"Methods,omitempty"`
	Priority        string   `protobuf:"bytes,7,opt,name=Priority,proto3" json:"Priority,omitempty"`
	Vars            string   `protobuf:"bytes,8,opt,name=Vars,proto3" json:"Vars,omitempty"`
	FilterFunc      string   `protobuf:"bytes,9,opt,name=FilterFunc,proto3" json:"FilterFunc,omitempty"`
	Upstream        string   `protobuf:"bytes,10,opt,name=Upstream,proto3" json:"Upstream,omitempty"`
	UpstreamId      string   `protobuf:"bytes,11,opt,name=Upstream_id,json=UpstreamId,proto3" json:"Upstream_id,omitempty"`
	ServiceId       string   `protobuf:"bytes,12,opt,name=ServiceId,proto3" json:"ServiceId,omitempty"`
	ServiceProtocol string   `protobuf:"bytes,13,opt,name=ServiceProtocol,proto3" json:"ServiceProtocol,omitempty"`
}
...
func (x *Router) GetRemoteAddr() string {
	if x != nil {
		return x.RemoteAddr
	}
	return ""
...
func (x *Router) GetMRemoteAddrs() []string {
	if x != nil {
		return x.MRemoteAddrs
	}
	return nil
}

func (x *Router) GetMethods() string {
	if x != nil {
		return x.Methods
	}
	return ""
...
func (x *Router) GetPriority() string {
	if x != nil {
		return x.Priority
	}
	return ""
...
func (x *Router) GetFilterFunc() string {
	if x != nil {
		return x.FilterFunc
	}
	return ""
...
func (x *Router) GetUpstream() string {
	if x != nil {
		return x.Upstream
	}
	return ""
...
func (x *Router) GetUpstreamId() string {
	if x != nil {
		return x.UpstreamId
	}
	return ""
...
func (x *Router) GetServiceId() string {
	if x != nil {
		return x.ServiceId
	}
	return ""
...
func (x *Router) GetServiceProtocol() string {
	if x != nil {
...
type ServerRequest struct {
	...
	HashOn          string   `protobuf:"bytes,3,opt,name=hash_on,json=hashOn,proto3" json:"hash_on,omitempty"`
	Key             string   `protobuf:"bytes,4,opt,name=Key,proto3" json:"Key,omitempty"`
	Checks          string   `protobuf:"bytes,5,opt,name=Checks,proto3" json:"Checks,omitempty"` //健康检查
	EnableWebsocket bool     `protobuf:"varint,6,opt,name=EnableWebsocket,proto3" json:"EnableWebsocket,omitempty"`
	Timeout         int32    `protobuf:"varint,7,opt,name=Timeout,proto3" json:"Timeout,omitempty"`
	Desc            string   `protobuf:"bytes,8,opt,name=Desc,proto3" json:"Desc,omitempty"`
	Name            string   `protobuf:"bytes,9,opt,name=Name,proto3" json:"Name,omitempty"`
	Router          *Router  `protobuf:"bytes,10,opt,name=Router,proto3" json:"Router,omitempty"`
}
...
func (x *ServerRequest) GetHashOn() string {
	if x != nil {
		return x.HashOn
	}
	return ""
...
func (x *ServerRequest) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *ServerRequest) GetChecks() string {
	if x != nil {
		return x.Checks
	}
	return ""
...
func (x *ServerRequest) GetEnableWebsocket() bool {
	if x != nil {
...
func (x *ServerRequest) GetTimeout() int32 {
	if x != nil {
		return x.Timeout
	}
	return 0
...
var file_reg_server_proto_rawDesc = []byte{
	...
	,
